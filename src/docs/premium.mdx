...
description: Premium is a paid rank that helps fund the server and its development. Similarly to Patreon, supporters purchase packages and get awesome perks as thanks for helping the server out. 
sidebar_position: 97
...
The price is in euro because EarthMC is operated from europe. For questions regarding your Premium, please email contact@earthmc.net.
